Pgd<- read.csv("~/Desktop/NADPH baseline/KK Lines/Pgd.csv")
source("~/Desktop/NADPH baseline/KK Lines/iNapKK_PgdKK (18) w corrections.R")
source("~/Desktop/NADPH baseline/KK Lines/iNapKK_PgdKK (18) wo corrections.R")
par(mfrow=c(2,4))
