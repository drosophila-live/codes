Pgd<- read.csv("~/Desktop/H2O2 baseline/HyPer - TRIP/20x Water/Pgd.csv")
source("~/Desktop/H2O2 baseline/HyPer - TRIP/20x Water/HyPerTRIP_PgdTRIP (13) w corrections.R")
source("~/Desktop/H2O2 baseline/HyPer - TRIP/20x Water/HyPerTRIP_PgdTRIP (13) wo corrections.R")
par(mfrow=c(2,4))
