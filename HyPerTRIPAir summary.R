source("~/Desktop/H2O2 baseline/HyPer - TRIP/20x AIR/HyPerTRIP_kl3 (13) plot.R")
source("~/Desktop/H2O2 baseline/HyPer - TRIP/20x AIR/HyPerTRIP_PgdTRIP (10) plot.R")
...
legend(x="bottomright",legend=c("kl"),cex=0.1,bty="n",lty=c(1,1,1),col=c("darkgreen"))
