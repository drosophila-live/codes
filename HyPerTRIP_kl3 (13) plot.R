kl3<- read.csv("~/Desktop/H2O2 baseline/HyPer - TRIP/20x AIR/kl3.csv")
source("~/Desktop/H2O2 baseline/HyPer - TRIP/20x AIR/HyPerTRIP_kl3 (13) w corrections.R")
source("~/Desktop/H2O2 baseline/HyPer - TRIP/20x AIR/HyPerTRIP_kl3 (13) wo corrections.R")
par(mfrow=c(2,4))
