...
iNap_PgdC_time_course<-c(PgdC_eyedisc_1,PgdC_eyedisc_2,PgdC_eyedisc_3,PgdC_eyedisc_4,PgdC_eyedisc_8,PgdC_eyedisc_9,PgdC_eyedisc_10,PgdC_eyedisc_11,PgdC_eyedisc_12,PgdC_eyedisc_13)
matiNap_PgdC_time_course<-matrix(iNap_PgdC_time_course,nrow=132,ncol=10)
mean_iNap_PgdC_time_course<-c(rowMeans(matiNap_PgdC_time_course))


iNap_PgdC_base<-c(iNap_PgdC_1_base,iNap_PgdC_2_base,iNap_PgdC_3_base,iNap_PgdC_4_base,iNap_PgdC_8_base,iNap_PgdC_9_base,iNap_PgdC_10_base,iNap_PgdC_11_base,iNap_PgdC_12_base,iNap_PgdC_13_base)
