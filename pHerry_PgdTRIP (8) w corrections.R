...
n_PgdC_4_488_base<-c(aa4[60]-(60*S_PgdC_4_488))
PgdC_4_488_base<-0
for(i in 51:60)
{PgdC_4_488_base<- S_PgdC_4_488*aa4[51:60]+n_PgdC_4_488_base}       # corrects all ten baseline values with the slope

n_PgdC_4_488_low<-c(aa4[85]-(85*S_PgdC_4_488))
PgdC_4_488_low<-0
for(i in 111:120)
{PgdC_4_488_low<- S_PgdC_4_488*aa4[111:120]+n_PgdC_4_488_low}       # corrects all ten low values with the slope

n_PgdC_4_488_peak<-c(aa4[120]-(120*S_PgdC_4_488))
PgdC_4_488_peak<-0
for(i in 76:85)
{PgdC_4_488_peak<- S_PgdC_4_488*aa4[76:85]+n_PgdC_4_488_peak}
...
PgdC_4_568_low<-0
for(i in 111:120)
{PgdC_4_568_low<- S_PgdC_4_568*bb4[111:120]+n_PgdC_4_568}

PgdC_4_568_peak<-0
for(i in 76:85)
{PgdC_4_568_peak<- S_PgdC_4_568*bb4[76:85]+n_PgdC_4_568}

PgdC_4_bpl<-c((PgdC_4_488_base/PgdC_4_568_base)/((PgdC_4_488_peak/PgdC_4_568_peak)/(PgdC_4_488_low/PgdC_4_568_low)))
PgdC_4_blp<-c((PgdC_4_488_base/PgdC_4_568_base)/((PgdC_4_488_low/PgdC_4_568_low)/(PgdC_4_488_peak/PgdC_4_568_peak)))
PgdC_4_btl<-c((PgdC_4_488_base/PgdC_4_568_base)/(PgdC_4_488_low/PgdC_4_568_low))
PgdC_4_btp<-c((PgdC_4_488_base/PgdC_4_568_base)/(PgdC_4_488_peak/PgdC_4_568_peak))

pHerry_PgdC_4_base<-c(mean(PgdC_4_488_base/PgdC_4_568_base)) 
pHerry_PgdC_4_bpl<-c(mean(PgdC_4_bpl))
pHerry_PgdC_4_blp<-c(mean(PgdC_4_blp))
pHerry_PgdC_4_btl<-c(mean(PgdC_4_btl))
pHerry_PgdC_4_btp<-c(mean(PgdC_4_btp))
...
pHerry_PgdC_time_course<-c(PgdC_eyedisc_3,PgdC_eyedisc_4,PgdC_eyedisc_5,PgdC_eyedisc_6,PgdC_eyedisc_7,PgdC_eyedisc_8,PgdC_eyedisc_9,PgdC_eyedisc_10)
matpHerry_PgdC_time_course<-matrix(pHerry_PgdC_time_course,nrow=120,ncol=8)
mean_pHerry_PgdC_time_course<-c(rowMeans(matpHerry_PgdC_time_course))

pHerry_PgdC_base<-c(pHerry_PgdC_3_base,pHerry_PgdC_4_base,pHerry_PgdC_5_base,pHerry_PgdC_6_base,pHerry_PgdC_7_base,pHerry_PgdC_8_base,pHerry_PgdC_9_base,pHerry_PgdC_10_base)
