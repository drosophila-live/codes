...
kl3UC_4_405_base<-c(aa5[51:60])
kl3UC_4_405_low<-c(aa5[76:85])
kl3UC_4_405_peak<-c(aa5[123:132])

kl3UC_4_568_base<-c(bb5[51:60])
kl3UC_4_568_low<-c(bb5[76:85])
kl3UC_4_568_peak<-c(bb5[123:132])
...
kl3UC_5_405_base<-c(aa5[51:60])
kl3UC_5_405_low<-c(aa5[76:85])
kl3UC_5_405_peak<-c(aa5[123:132])

kl3UC_5_568_base<-c(bb5[51:60])
kl3UC_5_568_low<-c(bb5[76:85])
kl3UC_5_568_peak<-c(bb5[123:132])

kl3UC_5_bpl<-c((kl3UC_5_405_base/kl3UC_5_568_base)/((kl3UC_5_405_peak/kl3UC_5_568_peak)/(kl3UC_5_405_low/kl3UC_5_568_low)))
kl3UC_5_blp<-c((kl3UC_5_405_base/kl3UC_5_568_base)/((kl3UC_5_405_low/kl3UC_5_568_low)/(kl3UC_5_405_peak/kl3UC_5_568_peak)))
kl3UC_5_btl<-c((kl3UC_5_405_base/kl3UC_5_568_base)/(kl3UC_5_405_low/kl3UC_5_568_low))
kl3UC_5_btp<-c((kl3UC_5_405_base/kl3UC_5_568_base)/(kl3UC_5_405_peak/kl3UC_5_568_peak))

iNap_kl3UC_5_base<-c(mean(kl3UC_5_405_base/kl3UC_5_568_base))               
iNap_kl3UC_5_bpl<-c(mean(kl3UC_5_bpl))
iNap_kl3UC_5_blp<-c(mean(kl3UC_5_blp))
iNap_kl3UC_5_btl<-c(mean(kl3UC_5_btl))
iNap_kl3UC_5_btp<-c(mean(kl3UC_5_btp))
...
aa12<-c(a12-b12)
bb12<-c(c12-d12)
kl3UC_eyedisc_12<-c(aa12/bb12)

kl3UC_12_405_base<-c(aa12[51:60])
kl3UC_12_405_low<-c(aa12[76:85])
kl3UC_12_405_peak<-c(aa12[123:132])

kl3UC_12_568_base<-c(bb12[51:60])
kl3UC_12_568_low<-c(bb12[76:85])
kl3UC_12_568_peak<-c(bb12[123:132])

kl3UC_12_bpl<-c((kl3UC_12_405_base/kl3UC_12_568_base)/((kl3UC_12_405_peak/kl3UC_12_568_peak)/(kl3UC_12_405_low/kl3UC_12_568_low)))
kl3UC_12_blp<-c((kl3UC_12_405_base/kl3UC_12_568_base)/((kl3UC_12_405_low/kl3UC_12_568_low)/(kl3UC_12_405_peak/kl3UC_12_568_peak)))
kl3UC_12_btl<-c((kl3UC_12_405_base/kl3UC_12_568_base)/(kl3UC_12_405_low/kl3UC_12_568_low))
kl3UC_12_btp<-c((kl3UC_12_405_base/kl3UC_12_568_base)/(kl3UC_12_405_peak/kl3UC_12_568_peak))

iNap_kl3UC_12_base<-c(mean(kl3UC_12_405_base/kl3UC_12_568_base))               
iNap_kl3UC_12_bpl<-c(mean(kl3UC_12_bpl))
iNap_kl3UC_12_blp<-c(mean(kl3UC_12_blp))
iNap_kl3UC_12_btl<-c(mean(kl3UC_12_btl))
iNap_kl3UC_12_btp<-c(mean(kl3UC_12_btp))
...
iNap_kl3UC_time_course<-c(kl3UC_eyedisc_1,kl3UC_eyedisc_2,kl3UC_eyedisc_3,kl3UC_eyedisc_4,kl3UC_eyedisc_5,kl3UC_eyedisc_6,kl3UC_eyedisc_7,kl3UC_eyedisc_8,kl3UC_eyedisc_9,kl3UC_eyedisc_10,kl3UC_eyedisc_11,kl3UC_eyedisc_12,kl3UC_eyedisc_13)
matiNap_kl3UC_time_course<-matrix(iNap_kl3UC_time_course,nrow=132,ncol=13)
mean_iNap_kl3UC_time_course<-c(rowMeans(matiNap_kl3UC_time_course))

iNap_kl3UC_bpl<-c(iNap_kl3UC_1_bpl,iNap_kl3UC_2_bpl,iNap_kl3UC_3_bpl,iNap_kl3UC_4_bpl,iNap_kl3UC_5_bpl,iNap_kl3UC_6_bpl,iNap_kl3UC_7_bpl,iNap_kl3UC_8_bpl,iNap_kl3UC_9_bpl,iNap_kl3UC_10_bpl,iNap_kl3UC_11_bpl,iNap_kl3UC_12_bpl,iNap_kl3UC_13_bpl)
iNap_kl3UC_blp<-c(iNap_kl3UC_1_blp,iNap_kl3UC_2_blp,iNap_kl3UC_3_blp,iNap_kl3UC_4_blp,iNap_kl3UC_5_blp,iNap_kl3UC_6_blp,iNap_kl3UC_7_blp,iNap_kl3UC_8_blp,iNap_kl3UC_9_blp,iNap_kl3UC_10_blp,iNap_kl3UC_11_blp,iNap_kl3UC_12_blp,iNap_kl3UC_13_blp)
iNap_kl3UC_btp<-c(iNap_kl3UC_1_btp,iNap_kl3UC_2_btp,iNap_kl3UC_3_btp,iNap_kl3UC_4_btp,iNap_kl3UC_5_btp,iNap_kl3UC_6_btp,iNap_kl3UC_7_btp,iNap_kl3UC_8_btp,iNap_kl3UC_9_btp,iNap_kl3UC_10_btp,iNap_kl3UC_11_btp,iNap_kl3UC_12_btp,iNap_kl3UC_13_btp)
iNap_kl3UC_btl<-c(iNap_kl3UC_1_btl,iNap_kl3UC_2_btl,iNap_kl3UC_3_btl,iNap_kl3UC_4_btl,iNap_kl3UC_5_btl,iNap_kl3UC_6_btl,iNap_kl3UC_7_btl,iNap_kl3UC_8_btl,iNap_kl3UC_9_btl,iNap_kl3UC_10_btl,iNap_kl3UC_11_btl,iNap_kl3UC_12_btl,iNap_kl3UC_13_btl)
iNap_kl3UC_base<-c(iNap_kl3UC_1_base,iNap_kl3UC_2_base,iNap_kl3UC_3_base,iNap_kl3UC_4_base,iNap_kl3UC_5_base,iNap_kl3UC_6_base,iNap_kl3UC_7_base,iNap_kl3UC_8_base,iNap_kl3UC_9_base,iNap_kl3UC_10_base,iNap_kl3UC_11_base,iNap_kl3UC_12_base,iNap_kl3UC_13_base)
