Pgd<- read.csv("~/Desktop/H2O2 baseline/HyPer - KK/Pgd.csv")
source("~/Desktop/H2O2 baseline/HyPer - KK/HyPerKK_PgdKK (16) w corrections.R")
source("~/Desktop/H2O2 baseline/HyPer - KK/HyPerKK_PgdKK (16) wo corrections.R")
par(mfrow=c(2,4))
