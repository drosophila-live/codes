...
aa8<-c(a8-b8)
bb8<-c(c8-d8)
kl3UC_eyedisc_8<-c(bb8/aa8)

kl3UC_8_568_base<-c(bb8[21:60])
kl3UC_8_568_peak<-c(bb8[85:94])
kl3UC_8_568_low<-c(bb8[141:150])

kl3UC_8_488_base<-c(aa8[21:60])
kl3UC_8_488_peak<-c(aa8[85:94])
kl3UC_8_488_low<-c(aa8[141:150])

kl3UC_8_blp<-c((kl3UC_8_568_base/kl3UC_8_488_base)/((kl3UC_8_568_low/kl3UC_8_488_low)/(kl3UC_8_568_peak/kl3UC_8_488_peak)))
kl3UC_8_bpl<-c((kl3UC_8_568_base/kl3UC_8_488_base)/((kl3UC_8_568_peak/kl3UC_8_488_peak)/(kl3UC_8_568_low/kl3UC_8_488_low)))
kl3UC_8_btp<-c((kl3UC_8_568_base/kl3UC_8_488_base)/(kl3UC_8_568_peak/kl3UC_8_488_peak))
kl3UC_8_btl<-c((kl3UC_8_568_base/kl3UC_8_488_base)/(kl3UC_8_568_low/kl3UC_8_488_low))

HyPer_kl3UC_8_base<-c(mean(kl3UC_8_568_base/kl3UC_8_488_base))               
HyPer_kl3UC_8_blp<-c(mean(kl3UC_8_blp))
HyPer_kl3UC_8_bpl<-c(mean(kl3UC_8_bpl))
HyPer_kl3UC_8_btp<-c(mean(kl3UC_8_btp))
HyPer_kl3UC_8_btl<-c(mean(kl3UC_8_btl))
...
aa16<-c(a16-b16)
bb16<-c(c16-d16)
kl3UC_eyedisc_16<-c(bb16/aa16)

kl3UC_16_568_base<-c(bb16[21:60])
kl3UC_16_568_peak<-c(bb16[85:94])
kl3UC_16_568_low<-c(bb16[141:150])

kl3UC_16_488_base<-c(aa16[21:60])
kl3UC_16_488_peak<-c(aa16[85:94])
kl3UC_16_488_low<-c(aa16[141:150])

kl3UC_16_blp<-c((kl3UC_16_568_base/kl3UC_16_488_base)/((kl3UC_16_568_low/kl3UC_16_488_low)/(kl3UC_16_568_peak/kl3UC_16_488_peak)))
kl3UC_16_bpl<-c((kl3UC_16_568_base/kl3UC_16_488_base)/((kl3UC_16_568_peak/kl3UC_16_488_peak)/(kl3UC_16_568_low/kl3UC_16_488_low)))
kl3UC_16_btp<-c((kl3UC_16_568_base/kl3UC_16_488_base)/(kl3UC_16_568_peak/kl3UC_16_488_peak))
kl3UC_16_btl<-c((kl3UC_16_568_base/kl3UC_16_488_base)/(kl3UC_16_568_low/kl3UC_16_488_low))

HyPer_kl3UC_16_base<-c(mean(kl3UC_16_568_base/kl3UC_16_488_base))               
HyPer_kl3UC_16_blp<-c(mean(kl3UC_16_blp))
HyPer_kl3UC_16_bpl<-c(mean(kl3UC_16_bpl))
HyPer_kl3UC_16_btp<-c(mean(kl3UC_16_btp))
HyPer_kl3UC_16_btl<-c(mean(kl3UC_16_btl))




HyPer_kl3UC_time_course<-c(kl3UC_eyedisc_1,kl3UC_eyedisc_2,kl3UC_eyedisc_3,kl3UC_eyedisc_4,kl3UC_eyedisc_5,kl3UC_eyedisc_6,kl3UC_eyedisc_7,kl3UC_eyedisc_8,kl3UC_eyedisc_9,kl3UC_eyedisc_10,kl3UC_eyedisc_12,kl3UC_eyedisc_13,kl3UC_eyedisc_14,kl3UC_eyedisc_15,kl3UC_eyedisc_16)
matHyPer_kl3UC_time_course<-matrix(HyPer_kl3UC_time_course,nrow=150,ncol=15)
mean_HyPer_kl3UC_time_course<-c(rowMeans(matHyPer_kl3UC_time_course))

HyPer_kl3UC_blp<-c(HyPer_kl3UC_1_blp,HyPer_kl3UC_2_blp,HyPer_kl3UC_3_blp,HyPer_kl3UC_4_blp,HyPer_kl3UC_5_blp,HyPer_kl3UC_6_blp,HyPer_kl3UC_7_blp,HyPer_kl3UC_8_blp,HyPer_kl3UC_9_blp,HyPer_kl3UC_10_blp,HyPer_kl3UC_12_blp,HyPer_kl3UC_13_blp,HyPer_kl3UC_14_blp,HyPer_kl3UC_15_blp,HyPer_kl3UC_16_blp)
HyPer_kl3UC_bpl<-c(HyPer_kl3UC_1_bpl,HyPer_kl3UC_2_bpl,HyPer_kl3UC_3_bpl,HyPer_kl3UC_4_bpl,HyPer_kl3UC_5_bpl,HyPer_kl3UC_6_bpl,HyPer_kl3UC_7_bpl,HyPer_kl3UC_8_bpl,HyPer_kl3UC_9_bpl,HyPer_kl3UC_10_bpl,HyPer_kl3UC_12_bpl,HyPer_kl3UC_13_bpl,HyPer_kl3UC_14_bpl,HyPer_kl3UC_15_bpl,HyPer_kl3UC_16_bpl)
HyPer_kl3UC_btl<-c(HyPer_kl3UC_1_btl,HyPer_kl3UC_2_btl,HyPer_kl3UC_3_btl,HyPer_kl3UC_4_btl,HyPer_kl3UC_5_btl,HyPer_kl3UC_6_btl,HyPer_kl3UC_7_btl,HyPer_kl3UC_8_btl,HyPer_kl3UC_9_btl,HyPer_kl3UC_10_btl,HyPer_kl3UC_12_btl,HyPer_kl3UC_13_btl,HyPer_kl3UC_14_btl,HyPer_kl3UC_15_btl,HyPer_kl3UC_16_btl)
HyPer_kl3UC_btp<-c(HyPer_kl3UC_1_btp,HyPer_kl3UC_2_btp,HyPer_kl3UC_3_btp,HyPer_kl3UC_4_btp,HyPer_kl3UC_5_btp,HyPer_kl3UC_6_btp,HyPer_kl3UC_7_btp,HyPer_kl3UC_8_btp,HyPer_kl3UC_9_btp,HyPer_kl3UC_10_btp,HyPer_kl3UC_12_btp,HyPer_kl3UC_13_btp,HyPer_kl3UC_14_btp,HyPer_kl3UC_15_btp,HyPer_kl3UC_16_btp)
HyPer_kl3UC_base<-c(HyPer_kl3UC_1_base,HyPer_kl3UC_2_base,HyPer_kl3UC_3_base,HyPer_kl3UC_4_base,HyPer_kl3UC_5_base,HyPer_kl3UC_6_base,HyPer_kl3UC_7_base,HyPer_kl3UC_8_base,HyPer_kl3UC_9_base,HyPer_kl3UC_10_base,HyPer_kl3UC_12_base,HyPer_kl3UC_13_base,HyPer_kl3UC_14_base,HyPer_kl3UC_15_base,HyPer_kl3UC_16_base)
