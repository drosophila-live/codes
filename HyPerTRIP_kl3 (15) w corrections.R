...
n_kl3C_8_568_base<-c(bb8[60]-(60*S_kl3C_8_568))
kl3C_8_568_base<-0
for(i in 51:60)
{kl3C_8_568_base<- S_kl3C_8_568*bb8[51:60]+n_kl3C_8_568_base}       # corrects all ten baseline values with the slope

n_kl3C_8_568_peak<-c(bb8[94]-(94*S_kl3C_8_568))
kl3C_8_568_peak<-0
for(i in 85:94)
{kl3C_8_568_peak<- S_kl3C_8_568*bb8[85:94]+n_kl3C_8_568_peak}       # corrects all ten low values with the slope

n_kl3C_8_568_low<-c(bb8[150]-(150*S_kl3C_8_568))
kl3C_8_568_low<-0
for(i in 141:150)
{kl3C_8_568_low<- S_kl3C_8_568*bb8[141:150]+n_kl3C_8_568_low}
...
n_kl3C_8_488<-c(aa8[60]-(60*S_kl3C_8_488))
kl3C_8_488_base<-0
for(i in 51:60)
{kl3C_8_488_base<- S_kl3C_8_488*aa8[51:60]+n_kl3C_8_488}

kl3C_8_488_peak<-0
for(i in 85:94)
{kl3C_8_488_peak<- S_kl3C_8_488*aa8[85:94]+n_kl3C_8_488}

kl3C_8_488_low<-0
for(i in 141:150)
{kl3C_8_488_low<- S_kl3C_8_488*aa8[141:150]+n_kl3C_8_488}

kl3C_8_blp<-c((kl3C_8_568_base/kl3C_8_488_base)/((kl3C_8_568_low/kl3C_8_488_low)/(kl3C_8_568_peak/kl3C_8_488_peak)))
kl3C_8_bpl<-c((kl3C_8_568_base/kl3C_8_488_base)/((kl3C_8_568_peak/kl3C_8_488_peak)/(kl3C_8_568_low/kl3C_8_488_low)))
kl3C_8_btp<-c((kl3C_8_568_base/kl3C_8_488_base)/(kl3C_8_568_peak/kl3C_8_488_peak))
kl3C_8_btl<-c((kl3C_8_568_base/kl3C_8_488_base)/(kl3C_8_568_low/kl3C_8_488_low))

HyPer_kl3C_8_base<-c(mean(kl3C_8_568_base/kl3C_8_488_base)) 
HyPer_kl3C_8_blp<-c(mean(kl3C_8_blp))
HyPer_kl3C_8_bpl<-c(mean(kl3C_8_bpl))
HyPer_kl3C_8_btp<-c(mean(kl3C_8_btp))
HyPer_kl3C_8_btl<-c(mean(kl3C_8_btl))
...
n_kl3C_16_568_base<-c(bb16[60]-(60*S_kl3C_16_568))
kl3C_16_568_base<-0
for(i in 51:60)
{kl3C_16_568_base<- S_kl3C_16_568*bb16[51:60]+n_kl3C_16_568_base}       # corrects all ten baseline values with the slope

n_kl3C_16_568_peak<-c(bb16[94]-(94*S_kl3C_16_568))
kl3C_16_568_peak<-0
for(i in 85:94)
{kl3C_16_568_peak<- S_kl3C_16_568*bb16[85:94]+n_kl3C_16_568_peak}       # corrects all ten low values with the slope

n_kl3C_16_568_low<-c(bb16[150]-(150*S_kl3C_16_568))
kl3C_16_568_low<-0
for(i in 141:150)
{kl3C_16_568_low<- S_kl3C_16_568*bb16[141:150]+n_kl3C_16_568_low}
...
n_kl3C_16_488<-c(aa16[60]-(60*S_kl3C_16_488))
kl3C_16_488_base<-0
for(i in 51:60)
{kl3C_16_488_base<- S_kl3C_16_488*aa16[51:60]+n_kl3C_16_488}

kl3C_16_488_peak<-0
for(i in 85:94)
{kl3C_16_488_peak<- S_kl3C_16_488*aa16[85:94]+n_kl3C_16_488}

kl3C_16_488_low<-0
for(i in 141:150)
{kl3C_16_488_low<- S_kl3C_16_488*aa16[141:150]+n_kl3C_16_488}

kl3C_16_blp<-c((kl3C_16_568_base/kl3C_16_488_base)/((kl3C_16_568_low/kl3C_16_488_low)/(kl3C_16_568_peak/kl3C_16_488_peak)))
kl3C_16_bpl<-c((kl3C_16_568_base/kl3C_16_488_base)/((kl3C_16_568_peak/kl3C_16_488_peak)/(kl3C_16_568_low/kl3C_16_488_low)))
kl3C_16_btp<-c((kl3C_16_568_base/kl3C_16_488_base)/(kl3C_16_568_peak/kl3C_16_488_peak))
kl3C_16_btl<-c((kl3C_16_568_base/kl3C_16_488_base)/(kl3C_16_568_low/kl3C_16_488_low))

HyPer_kl3C_16_base<-c(mean(kl3C_16_568_base/kl3C_16_488_base)) 
HyPer_kl3C_16_blp<-c(mean(kl3C_16_blp))
HyPer_kl3C_16_bpl<-c(mean(kl3C_16_bpl))
HyPer_kl3C_16_btp<-c(mean(kl3C_16_btp))
HyPer_kl3C_16_btl<-c(mean(kl3C_16_btl))



HyPer_kl3C_time_course<-c(kl3C_eyedisc_1,kl3C_eyedisc_2,kl3C_eyedisc_3,kl3C_eyedisc_4,kl3C_eyedisc_5,kl3C_eyedisc_6,kl3C_eyedisc_7,kl3C_eyedisc_8,kl3C_eyedisc_9,kl3C_eyedisc_10,kl3C_eyedisc_12,kl3C_eyedisc_13,kl3C_eyedisc_14,kl3C_eyedisc_15,kl3C_eyedisc_16)
matHyPer_kl3C_time_course<-matrix(HyPer_kl3C_time_course,nrow=150,ncol=15)
mean_HyPer_kl3C_time_course<-c(rowMeans(matHyPer_kl3C_time_course))

HyPer_kl3C_base<-c(HyPer_kl3C_1_base,HyPer_kl3C_2_base,HyPer_kl3C_3_base,HyPer_kl3C_4_base,HyPer_kl3C_5_base,HyPer_kl3C_6_base,HyPer_kl3C_7_base,kl3C_eyedisc_8,HyPer_kl3C_9_base,HyPer_kl3C_10_base,HyPer_kl3C_12_base,HyPer_kl3C_13_base,HyPer_kl3C_14_base,HyPer_kl3C_15_base,HyPer_kl3C_16_base)
