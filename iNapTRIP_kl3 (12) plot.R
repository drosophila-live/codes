kl3<- read.csv("~/Desktop/NADPH baseline/TRIP/kl3.csv")
source("~/Desktop/NADPH baseline/TRIP/iNapTRIP_kl3 (12) w corrections.R")
source("~/Desktop/NADPH baseline/TRIP/iNapTRIP_kl3 (12) wo corrections.R")
par(mfrow=c(2,4))
